...
const { dbConfigObject } = require('./configs/poolconfigs');
const poolCamunda = new Pool(dbConfigObject.configCamunda);
const poolSearch = new Pool(dbConfigObject.configSearchstore);
const poolApplication = new Pool(dbConfigObject.configApplication);
const poolCCapplication = new Pool(dbConfigObject.configCCapplication);
const poolAdministration = new Pool(dbConfigObject.configAdministration);
const poolStatusview = new Pool(dbConfigObject.configStatusview);
const poolMapplication = new Pool(dbConfigObject.configMapplication);
const poolAutoApplication = new Pool(dbConfigObject.configAutoApplication);
const poolMrealEstate = new Pool(dbConfigObject.configMrealestate);
const poolClientService = new Pool(dbConfigObject.configClientService);
  ...
  if (input) {
    ...
    switch (route) {
      case 'ERROR_1':
        ...
        result = await poolCamunda.query(
          sql.SQL_SELECT_CAMUNDA_VARIABLE_ERROR_MESSAGE,
        );
      ...
      case 'ERROR_2':
        ...
        result = await poolCamunda.query(
          sql.SQL_SELECT_CAMUNDA_VARIABLE_ERROR_STACK_TRACE,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'ERROR_3':
        ...
        result = await poolCamunda.query(
          sql.SQL_SELECT_CAMUNDA_VARIABLE_ERROR_BUSINESS,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'ipoteka_real_estate':
        ...
        result = await poolMapplication.query(
          sql.SQL_SELECT_MAPPLICATION_REAL_ESTATE_ID,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'ipoteka_real_estate_2':
        sql.SQL_SELECT_MREALESTATE_REAL_ESTATE.values[0] = input;
        result = await poolMrealEstate.query(
          sql.SQL_SELECT_MREALESTATE_REAL_ESTATE,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'evaluation_report':
        ...
        result = await poolMrealEstate.query(
          sql.SQL_SELECT_MREALESTATE_EVALUATION_REPORT,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'ipoteka_participant':
        ...
        result = await poolMapplication.query(
          sql.SQL_SELECT_MAPPLICATION_PARTICIPANTS,
        );
        result = result.rows;
      ...
      case 'mapplication':
        ...
        result = await poolMapplication.query(
          sql.SQL_SELECT_MAPPLICATION_APPLICATION,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'application':
      ...
      case 'ccapplication':
        ...
        result = await poolCCapplication.query(
          sql.SQL_SELECT_CCAPPLICATION_APPLICATION,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'auto_application':
        ...
        result = await poolAutoApplication.query(
          sql.SQL_SELECT_AUTOAPPLICATION_DATA,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'contract_card':
        ...
        result = await poolCCapplication.query(
          sql.SQL_SELECT_CCAPPLICATION_CONTRACT_PARAMETERS,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'letter_of_credit':
        ...
        result = await poolMapplication.query(
          sql.SQL_SELECT_MAPPLICATION_DATA_LETTER_OF_CREDIT,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'agreement_purchase':
        ...
        result = await poolMapplication.query(
          sql.SQL_SELECT_MAPPLICATION_AGGREEMENT_PURCHASE,
        );
        result = getStrResultset(result.rows);
        return result;
      ...
      case 'transfer_order':
        ...
        result = await poolMapplication.query(
          sql.SQL_SELECT_MAPPLICATION_TRANSFER_ORDER,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'legal_document':
        ...
        result = await poolMapplication.query(
          sql.SQL_SELECT_MAPPLICATION_LEGAL_DOCUMENT,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'execution_log':
        ...
        result = await poolSearch.query(
          sql.SQL_SELECT_SEARCHSTORESERVICE_BPM_EXECUTIONS,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'process_log':
        ...
        result = await poolCamunda.query(
          sql.SQL_SELECT_CAMUNDA_PROCESS_HISTORY,
        );
        result = getStrResultset(result.rows);
        return result;
      case 'job_data':
      ...
      case 'auto_client':
        ...
        result = result.rows;
        sql.SQL_SELECT_CLIENTSERVICE_PARTICIPANT.values[0] =
          result[0].participant_form_id;
        participantAdditional = await poolClientService.query(
      ...
      default:
        throw new Error(
          `RequestProcessor.getAsyncData: Не удалось распознать маршрут ${route}`,
        );
    }
  } else {
    let voidArr = [];
...
const getDataApp = (p1, p2) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (p2 == 'search') {
      ...
      poolSearch.query(
        sql.SQL_SELECT_SEARCHSTORESERVICE_APPLICATIONSEARCH,
        (err, res) => {
          if (err) {
            throw err;
          }
...
const getParemetersData = (p1, p2) => {
  ...
  return new Promise((resolve, reject) => {
    if (p2 == 'potreb') {
      console.log(
        `Request Processor: Route detected as ${p2}, starting to process...` +
          '\n',
      );

      poolApplication.query(
        sql.SQL_SELECT_APPLICATION_CREDIT_PARAMETERS,
        (err, res) => {
          if (err) {
            throw err;
          }
          ...
          dateTime.getCurrentDateTime();
          console.log(
            `Request Processor: Data has been collected for ${p2}` + '\n',
          );
          resolve(out);
        },
      );
    ...
    if (p2 == 'auto') {
      ...
      poolAutoApplication.query(
        sql.SQL_SELECT_AUTOAPPLICATION_CREDIT_PARAMETERS,
        (err, res) => {
          if (err) {
            throw err;
          }
    ...
    if (p2 == 'autoakk') {
      ...
      poolAutoApplication.query(
        sql.SQL_SELECT_AUTOAPPLICATION_ACCOUNTS,
        (err, res) => {
          if (err) {
            throw err;
          }
    ...
    if (p2 == 'vehicle') {
      ...
      dateTime.getCurrentDateTime();
      console.log(
        `Request Processor: Starting to collect data for route ${p1} ${p2}` +
          '\n',
      );

      poolAutoApplication.query(
        sql.SQL_SELECT_AUTOAPPLICATION_VEHICLE,
        (err, res) => {
          if (err) {
            throw err;
          }
    ...
    if (p2 == 'potrebrefin') {
      ...
      poolApplication.query(
        sql.SQL_SELECT_APPLICATION_REFINANCE_2,
        (err, res) => {
          if (err) {
            throw err;
          }
    ...
    if (p2 == 'cc') {
      ...
      poolCCapplication.query(
        sql.SQL_SELECT_CCAPPLICATION_CREDIT_PARAMETERS,
        (err, res) => {
          if (err) {
            throw err;
          }
          ...
          dateTime.getCurrentDateTime();
          console.log(
            `Request Processor: Data collected for credit card` + '\n',
          );
          resolve(out);
        },
      );
    ...
    if (p2 == 'ipoteka') {
      ...
      poolMapplication.query(
        sql.SQL_SELECT_MAPPLICATION_CREDIT_PARAMETERS,
        (err, res) => {
          if (err) {
            throw err;
          }
    ...
    if (p2 == 'ipoteka_akk') {
      ...
      poolMapplication.query(
        sql.SQL_SELECT_MAPPLICATION_ACCOUNTS,
        (err, res) => {
          if (err) {
            throw err;
          }
    ...
    if (p2 == 'kard_akk') {
      ...
      poolCCapplication.query(
        sql.SQL_SELECT_CCAPPLICATION_ACCOUNTS,
        (err, res) => {
          if (err) {
            throw err;
          }
...
const getIntegrationsLog = p1 => {
  ...
  return new Promise((resolve, reject) => {
    poolAdministration.query(sql.sqladmin, (err, res) => {
      ...
      dateTime.getCurrentDateTime();
      console.log(
        `Request Processor: Integration data has been collected` + '\n',
      );
      resolve(intarr);
    });
  });
...
const getMonitoringData = p => {
  dateTime.getCurrentDateTime();
  console.log(
    `Request Processor: Received request for ${p} pool data for monitoring` +
      '\n',
  );
  ...
  return new Promise((resolve, reject) => {
    if (p == 'integration') {
      poolAdministration.query(sql.sqlmon, (err, res) => {
        ...
        dateTime.getCurrentDateTime();
        console.log(
          `Request Processor: Monitoring data has been collected` + '\n',
        );
        resolve(montarr);
      });
    }
