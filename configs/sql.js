...
module.exports.SQL_SELECT_APPLICATION_CREDIT_PARAMETERS = {
  text: `select * from application.application.credit_parameters where application_id = (select distinct (id) from application.application.applications where app_sequence = $1)`,
  values: []
};
//sqlApplication
